...
import { lonToSignDeg } from './units';
import { jdnToBabylonian, urukSchemeOf, formatSchematic, formatBabylonianDate } from './calendar';
import {
	babylonSign, babylonPlanet, exaltationOf, triplicityOfSign, triplicityOfMonth,
	daySegmentLord, termLordOfDeg, landOfMonth,
} from '../data/babylonianData';
import { dodeca12 } from './microzodiac';
