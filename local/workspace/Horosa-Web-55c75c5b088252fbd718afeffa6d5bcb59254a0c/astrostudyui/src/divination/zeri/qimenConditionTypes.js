...
import { GROUP_TYPES } from './conditionTypes';
import {
	BAGONG_PALACE_NAME,
...
import { LUOSHU_NUM } from '../../components/dunjia/DunJiaFaDoc';
// [W3 全谱轮] 旺衰五路=主页「看旺衰」同函数(DunJiaCalc.buildQimenWangShuai);
// 伏反吟局=法奇门同函数(全盘级,≠宫级伏吟格)。
import { buildQimenWangShuai } from '../../components/dunjia/DunJiaCalc';
import { computePanType } from '../../components/dunjia/DunJiaFaCalc';
