...
import { TONGSHU_TERMS, YONGSHI_YIJI_SYN, yongshiVerdict } from '../../components/calendar/tongshuData';
// [W6 全谱轮] 通书五流派判定=通书页同函数(直调,主表修正择日自动跟);玄空 mingYear 缺省=天地判。
import donggongDay from '../../components/calendar/tongshu/donggong';
import { wutuForDate } from '../../components/calendar/tongshu/wutu';
import { qimenDieShuDay } from '../../components/calendar/tongshu/qimenDieShu';
import { sanyuanLiexiuDay } from '../../components/calendar/tongshu/sanyuanLiexiu';
import { xuankongDay } from '../../components/calendar/tongshu/xuankong';
import { GROUP_TYPES, JOINER_CN } from './conditionTypes';
