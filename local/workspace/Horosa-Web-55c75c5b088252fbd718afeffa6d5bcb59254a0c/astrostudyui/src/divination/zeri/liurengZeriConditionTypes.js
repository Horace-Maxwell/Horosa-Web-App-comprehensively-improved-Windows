...
import { TianJiang, ZiList } from '../../components/liureng/LRConst';
import { GROUP_TYPES, JOINER_CN } from './conditionTypes';
// [W2 全谱轮] 小局/大格判定单源=主页右栏同函数(prebuilt 直供跳重算;涉日月宿位的局无星历不判)。
import { buildLiuRengReferenceContext, matchXiaoJuReferences, matchDaGeReferences, XIAO_JU_META, DA_GE_META } from '../../components/lrzhan/LiuRengMain';
import { changShengOf } from '../../utils/baziLunarLocal';
import { GanJiZi } from '../../components/liureng/LRConst';
