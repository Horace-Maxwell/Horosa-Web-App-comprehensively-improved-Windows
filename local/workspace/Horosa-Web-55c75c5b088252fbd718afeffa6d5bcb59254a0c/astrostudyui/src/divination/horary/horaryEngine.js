...
import { radicality, hourAgreementTest } from '../engine/radicality';
...
import { applyingAspects, separatingAspects, aspectsOf, aspectBetween } from '../engine/aspectsEngine';
import { almutenAt } from '../engine/almuten';
import { assignSignificators, moonPromotionCheck } from './significators';
...
import { lotDispositor, LOTS_SETS, computeLotsSet } from '../data/lots';
import { angularDist, norm360 } from '../engine/utils';
import { besiegementOf, backendStarsOf } from '../engine/resultShapes';
import { buildVerdictScored } from './verdictScoring';
import { resolveMoonVoc } from '../engine/moon';   // [Q-146] 月空单源(随流派口径)
...
function buildMoonStory(facts, includeOuter){
	...
	const { keyOfChartId } = require('../engine/utils');
...
function moonFinalAspect(facts, includeOuter){
	...
	const { signedDelta } = require('../engine/utils');
