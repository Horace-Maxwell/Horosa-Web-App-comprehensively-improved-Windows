...
import { houseNum as dcHouseNum, signOf as dcSignOf } from './dispositorChain';
import { KLIMATA, SIGN_CN, PLANET_CN, THEMA_MUNDI, parseSignDegree } from '../divination/data/hellenisticData';
...
export function computePredominator(chartObj, opts){
	...
	const { SIGNS } = require('../divination/data/signs');
	const { termRulerForVariant } = require('../divination/engine/almuten');
