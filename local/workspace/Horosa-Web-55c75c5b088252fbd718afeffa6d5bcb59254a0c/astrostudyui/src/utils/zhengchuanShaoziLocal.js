...
import { taixuanPeishu } from './tiebanFrameworkLocal';
import { guaFromLines, analyzeLiuyao } from '../components/gua/liuyaoFacade';
...
export function loadShaoziVerses() {
	if (!versesPromise) {
		versesPromise = import(/* webpackChunkName: "zhengchuan-verses-shaozi" */ './data/zhengchuanShaoziVerses.json')
			.then((m) => m.default || m);
	}
