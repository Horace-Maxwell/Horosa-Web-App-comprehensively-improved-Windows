...
export const TECHNIQUE_ONBOARDING_CONTRACT = {
	...
	cnyibu: { help: 'registry', aiExport: ['jinkou', 'wuzhao', 'taixuan', 'jingjue', 'shenyishu', 'huangji', 'guice', 'tongshefa', 'geomancy', 'tarot', 'lingqi', 'xiaoliuren', 'xiaochengtu', 'feigong', 'suzhan', 'otherbu'], mount: 'viaPresets', archive: 'case:jinkou,wuzhao,taixuan,jingjue,shenyishu,huangji,guice,tongshefa,geomancy,tarot,lingqi,xiaoliuren,xiaochengtu,feigong,suzhan', storageKeys: ['horosa.lingqi.settings.v1', 'horosa.guice.settings.v1', 'horosa.feigong.settings.v1', 'horosa.xiaochengtu.settings.v1', 'horosa.xiaoliuren.settings.v1', 'suzhanChartType', 'horosa.tarot.personalMeanings', 'horosa.tarot.dailyLog'] },
