...
import { wutuForDate } from './tongshu/wutu';   // [Q-458/T-421] 乌兔九星值日(与 lunar 的「九星值日」非同一体系)
import { buildYearAuspicious } from './yearAuspicious';   // [Q-458/T-421] 年度吉日榜(候选段,开过面板才产)
