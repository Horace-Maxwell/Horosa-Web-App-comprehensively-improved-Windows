						...
						<div style={body}>
							...
							<div style={card}><div style={ct}>人物关系</div>
								...
								<div style={card}><div style={ct}>玄学地图</div>
									{kv('实为', '玄学事件按发生城市定位的钉点图 —— 中国底图上,每座城市一枚朱砂钉点(effectScatter 涟漪),点半径 ∝ 该城事件数量;并非人物地理分布,也无按朝代着色的分层。')}
									...
									{kv('右栏城市榜', '按事件数从多到少列出城市(至多前 50),每行含今地名 / 古地名 / 各史书分项计数;点某行与地图钉点联动高亮。')}</div>
						</div>
					</TabPane>
