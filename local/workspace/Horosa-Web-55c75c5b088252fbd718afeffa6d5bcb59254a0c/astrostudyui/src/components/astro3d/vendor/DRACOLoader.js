// three r0.185 DRACOLoader 的本仓 patched 副本(WS-0 three 升级,2026-07-16)。
// 唯一改动:5 处 new URL(..., import.meta.url) 默认 decoder 路径改为静态空串 ——
// umi3=webpack4 不支持 import.meta 语法,原文件直接编译失败;而本仓恒调 setDecoderPath()
// 指向 public/gltf/draco,默认 URL 从未被消费。three 再升级时:重拷原文件+重打此 patch。
import {
	BufferAttribute,
	BufferGeometry,
	Color,
