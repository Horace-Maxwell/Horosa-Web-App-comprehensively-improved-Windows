...
FILES = {
    ...
    ".claude/skills/horosa-dev/references/gotchas-full.md": "the full institutional gotcha archive #1-#96 (verbatim history + topic index; new gotchas append HERE, newest-first in the list). ★ Read the topic index first — rows '我方自研改造把产品搞坏的四类'(#79/#84/#83④/#94) / '上游护栏在 Windows 假阳'(#86+#96 pathsep 四例) / '验证手段本身不可信'(#71) are the highest-recurrence traps.",
