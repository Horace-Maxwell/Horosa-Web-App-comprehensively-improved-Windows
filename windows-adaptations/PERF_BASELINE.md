...
- version: 3.6.0
- build: release(v3.6.0 同步发布轮:主限方位法全谱/印占大扩容/西占中式纵深/巴比伦新技法;
  核心 10 键验收当轮重跑[见「v3.6.0 键石复测」节],全 25 键表沿 07-22 口径存档,
  台架对 3.6.0 新 UI 的全量适配为下轮跟进项)
- date: 2026-07-31(键石复测与启动面实测日;逐技法全表存档日 2026-07-22)
- commit: a2125ff(v3.6.0 同步轮)
